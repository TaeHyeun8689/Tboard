							...
							<div class="panel-body">
								...
								<div class="row">
									<form id="update" action="update" method="post">
										<!-- hidden value -->
										<input type="hidden" id="number" name="number" value="${user_content.board_num}">
										<input type="hidden" id="writer" name="writer" value="${user_content.board_writer}">
										<div class="input-group">
											<span class="input-group-addon">
												<i class="glyphicon glyphicon-user"></i>
											</span>
											<input readonly id="id" type="text" class="form-control" name="id" value="${login_session.user_id}">
										</div>
										<div class="input-group">
											<span class="input-group-addon">제목</span>
											<input id="title" type="text" class="form-control" name="title" placeholder="글 제목" value="${user_content.board_title}">
										</div>
										<!-- 네이버 스마트 에디터 -->
										<textarea name="content" id="content" rows="10" cols="128">${user_content.board_content}</textarea>
